...
class UpdateProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'file'        => 'sometimes|nullable|file|mimes:jpg,jpeg,png,pdf|max:2048',
        ];
    }
